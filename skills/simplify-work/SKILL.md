...
- If the change requires new product behavior, a public API or compatibility trade-off, or unresolved architecture placement, stop for owner judgment or route discovery to `improve-architecture`.
