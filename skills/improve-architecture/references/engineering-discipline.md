...
Apply these as proportionate heuristics. Repo conventions govern generic defaults; surface material conflicts with the current request with a recommendation rather than silently choosing. Specialized stack guidance may refine them without silently overriding the repo.
